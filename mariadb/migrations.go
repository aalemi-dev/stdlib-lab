...
func (p *MariaDB) ensureMigrationHistoryTable(dbConn interface{ AutoMigrate(...interface{}) error }) error {
...
func (p *MariaDB) loadMigrations(dir string, direction MigrationDirection) ([]Migration, error) {
